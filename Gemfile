...
gem 'tzinfo-data'
gem 'valid_email2'
# Uglifier removed - no frontend assets to compress
...
gem 'foreman'
gem 'puma'
# vite_rails removed - API only mode
# metrics on heroku
gem 'barnes'
# Prometheus metrics
...
# for dialogflow integrations - REMOVED (not used)
# gem 'google-cloud-dialogflow-v2', '>= 0.24.0'
# gem 'grpc'
# Translate integrations - REMOVED (not used)
